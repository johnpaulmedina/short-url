...
```php
\JohnPaulMedina\ShortUrl\Facades\ShortUrl::routes();
```
...
```php
$shortURL = \JohnPaulMedina\ShortUrl\Models\ShortUrl::find(1);
...
```php
$shortURL = \JohnPaulMedina\ShortUrl\Models\ShortUrl::findByKey('abc123');
``` 
...
```php
$shortURLs = \JohnPaulMedina\ShortUrl\Models\ShortUrl::findByDestinationURL('https://destination.com');
```
...
```php
$shortURL = \JohnPaulMedina\ShortUrl\Models\ShortUrl::first();
