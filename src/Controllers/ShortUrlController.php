...
namespace JohnPaulMedina\ShortUrl\Controllers;

use JohnPaulMedina\ShortUrl\Classes\Resolver;
...
class ShortUrlController
{
    ...
    {
        $shortURL = ShortUrl::where('url_key', urlencode($shortURLKey))->firstOrFail();
